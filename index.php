...
<style>
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">လျှို့ဝှက်ပုံများ မျှဝေခြင်း</a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href="index.php">မူလစာမျက်နှာ</a></li>
              <!--li><a href="instruction.php">အသုံးပြုပုံ</a></li-->
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </nav>
  ...
  <div class="form-group">
      ...
      <div class="col-sm-10">       
              ...
              <input type="text" class="hidden" id="original_photo_data" name="original_photo_data"  required>
      </div>
    </div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">       
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" placeholder="စကားဝှက် " name="password">
      </div>
    </div>
