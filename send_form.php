...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h2>လျှို့ဝှက်ပုံများ မျှဝေခြင်း စနစ်</h2>
...
#$stegano_test_photo_url = "images/".$image_filename."test.png";
#$stegano_test2_photo_url = "images/".$image_filename."test2.png";
...
#$stegano_test_photo = $cover_photo; # copy image resource
imagepng($cover_photo,$cover_photo_url); # write image resource to file path
#imagepng($stegano_test_photo,$stegano_test_photo_url); # write image resource to file path
...
// echo "<br>json";
// echo json_encode($gray_one_d_array);
// gray one d array loop
// echo "<p>gray one d array </p>";
// for($i = 0 ; $i< 20; $i++){
// 	echo $gray_one_d_array[$i]."<br>";
// }
...
//$gray_transposited_one_d_array = $gray_one_d_array;
// gray one d array loop
// echo "<p>gray_transposited_one_d_array </p>";
// for($i = 0 ; $i< 20; $i++){
// 	echo $gray_transposited_one_d_array[$i]."<br>";
// }


// echo "<br>gray_transposited_one_d_array";
// echo json_encode($gray_transposited_one_d_array);
...
$shareable_link = "http://localhost/myanmar_image/image/".$image_filename;
...
?>
<input style="width:100%" type='text' id='sharable_link' value='<?php echo $shareable_link; ?>' />
<br><br>
